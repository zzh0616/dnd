...
> **创建草案，20 级开局。** 本卡采用玩家提供的 2024 预言学派法师构筑及已确认的 [新团团桌规则](../rulings.md)。开局前抄录与拟像术已确认可完成；物品价格、基地位置、外部神术与其他预设施法仍须经 DM 确认后才成为本团事实。
...
| 命运恩惠 / Boon of Fate | 1 / 1（短休或长休恢复 / Short or Long Rest） |
...
| 法术施法属性 / Spellcasting Ability | 智力 / Intelligence |
| 语言 / Languages | 通用语 / Common；龙语 / Draconic；天界语 / Celestial（后两门待世界观确认） |
| 工具 / Tool | 盗贼工具 / Thieves' Tools |

## 属性、豁免与技能 / Abilities, Saves, and Skills

### 属性 / Ability Scores

| 属性 / Ability | 自然值 / Natural | 当前值 / Current | 调整值 / Modifier |
|---|---:|---:|---:|
| 力量 / Strength | 8 | 8 | -1 |
...
| 属性 / Ability | 加值 / Bonus | 熟练 / Proficient |
|---|---:|---|
| 力量 / Strength | -1 | 否 / No |
| 敏捷 / Dexterity | +2 | 否 / No |
...
### 常用行动与反应 / Common Actions and Reactions

| 类型 / Type | 能力 / Ability | 效果摘要 / Summary |
|---|---|---|
| 戏法 / Cantrip | 心灵之楔 / Mind Sliver | 智力豁免伤害，并削弱目标下一次豁免 / Int-save damage; weakens next save |
| 戏法 / Cantrip | 冻寒射线 / Ray of Frost | 远程寒冷伤害并减速 / ranged cold damage and slow |
| 戏法 / Cantrip | 火焰箭 / Fire Bolt | 远程火焰伤害；可点燃未被携带的易燃物 / ranged fire damage; ignites unattended flammables |
| 戏法 / Cantrip | 法师之手 / Mage Hand | 远距操作轻型物品与机关 / manipulate light objects and hazards at range |
| 戏法 / Cantrip | 次级幻影 / Minor Illusion | 制造声音或影像诱饵 / create a sound or image decoy |
| 反应 / Reaction | 护盾术 / Shield | 本轮 AC +5，作为第一层保命反应 / +5 AC for the round |
| 反应 / Reaction | 法术反制 / Counterspell | 标志法术；每次短休或长休各有一次免费 3 环施放 / Signature Spell, one free 3rd-level casting per Short or Long Rest |
| 反应 / Reaction | 预兆 / Portent | 施展前以预先掷出的 d20 替代可见生物的 d20 / replace a seen creature's d20 before the roll |

### 法师与预言学派 / Wizard and Diviner Features

| 能力 / Feature | 规则摘要 / Summary |
|---|---|
| 仪式学者 / Ritual Adept | 法术书中的仪式法术可不准备，以仪式施放 / cast Ritual spells from the spellbook without preparing them |
| 奥术回想 / Arcane Recovery | 每长休一次；完成短休后恢复总环数 10、单个环位至多 5 环 / once per Long Rest after a Short Rest, recover slots totaling 10 levels, no slot above 5th |
| 学者 / Scholar | 调查 / Investigation 获得专精 / Expertise in Investigation |
| 预言学者 / Diviner Savant | 升环时加入预言法术；已计入法术书 / Divination spells gained with new spell levels; already included in spellbook |
| 预兆与强效预兆 / Portent, Greater Portent | 每长休掷 3 个 d20；替代可见生物的关键 d20 / roll three d20s per Long Rest and substitute a seen creature's key d20 |
| 专精预言 / Expert Divination | 用 2 环或更高环位施放预言法术后，恢复一个更低环位（至多 5 环）/ casting a 2nd-level+ Divination spell recovers a lower slot, up to 5th level |
| 第三只眼 / The Third Eye | 每短休或长休一次，选择 120 尺黑暗视觉、阅读任意语言，或免费施放识破隐形 / choose 120-ft Darkvision, read any language, or cast See Invisibility for free |
...
|---|---|---|
| 人类 / Human | 足智多谋 / Resourceful | 每次长休后获得英雄激励 / gain Heroic Inspiration after each Long Rest |
| 人类 / Human | 技能娴熟 / Skillful | 调查熟练 / Investigation proficiency |
| 人类 / Human | 多才多艺 / Versatile | 获得幸运儿起源专长 / gain Lucky Origin feat |
| 罪犯 / Criminal | 警觉 / Alert | 先攻加入熟练加值；可与自愿盟友交换先攻 / add PB to Initiative; swap with a willing ally |
| 专长 / Feat | 幸运儿 / Lucky | 每长休 6 点，关键 d20 后消耗 1 点介入 / six points per Long Rest; spend after a key d20 |
| 专长 / Feat | 战地施法者 / War Caster | 体质专注豁免具有优势 / Advantage on Constitution saves to maintain Concentration |
...
### 默认准备法术（25 个）/ Default Prepared Spells (25)

> 用于情报不完整的常规出发日。高环法术不再只放进法术书：预见术、心灵屏障、传送术、力场囚笼、迷宫术和祈愿术均在默认准备中。仪式法术不占此处名额。
...
| 5 环 / 5th | 力场墙 / Wall of Force；突触静止 / Synaptic Static |
| 6 环 / 6th | 法术无效结界 / Globe of Invulnerability |
...
| 类型 / Type | 法术 / Spell | 使用方式 / Use |
|---|---|---|
| 法术精通 / Spell Mastery | 大步奔行 / Longstrider | 始终准备，无需法术位 / always prepared, no slot |
| 法术精通 / Spell Mastery | 镜影术 / Mirror Image | 始终准备，无需法术位 / always prepared, no slot |
| 标志法术 / Signature Spell | 法术反制 / Counterspell | 始终准备；每短休或长休一次免费 3 环施放 / always prepared; one free 3rd-level casting per Short or Long Rest |
| 标志法术 / Signature Spell | 解除魔法 / Dispel Magic | 始终准备；每短休或长休一次免费 3 环施放 / always prepared; one free 3rd-level casting per Short or Long Rest |
| 仪式 / Ritual | 警报术、侦测魔法、寻获魔宠、鉴定术等 / Alarm, Detect Magic, Find Familiar, Identify, etc. | 写在法术书即可仪式施放，不占准备位 / cast from spellbook as Rituals without preparation |

### 根据情报替换 / Swap Packages

| 敌情 / Threat | 加入 / Add | 可优先换出 / First to Swap Out |
|---|---|---|
| 隐形刺客、敌方法师 / Invisible assassins, mages | 识破隐形 / See Invisibility；真知术 / True Seeing；解离术 / Disintegrate | 蛛网术、催眠图纹、缓慢术 |
...
| 已知反魔法领域且在固定通道交战 / Known Antimagic Field at a fixed choke point | 虹光法墙 / Prismatic Wall；石墙术 / Wall of Stone；识破隐形 / See Invisibility；反制法术 / Counterspell 始终可用 | 预见术、蛛网术、催眠图纹；虹光法墙只能分割、拖延或封锁通道，必须在领域覆盖前建立，不能当作通用进攻法术 |

### 后 20 级进阶 / Post-20 Advancement

> 每次胜利后，法师准备位 +1、法术位不变，并额外获得 1 个兼职等级。每场胜利后下一名主要敌人 CR +2；完整规则见 [团桌规则](../rulings.md)。以下是**尚未获得**的推荐路线，不应提前结算到当前状态。
...
| 9 环 / 9th | 异界之门 / Gate；预见术 / Foresight；流星爆 / Meteor Swarm；律令死亡 / Power Word Kill；虹光法墙 / Prismatic Wall；形体变化 / Shapechange；时间停止 / Time Stop；完全变形术 / True Polymorph；祈愿术 / Wish |

## 装备与魔法物品 / Equipment and Magic Items

### 同调物品 / Attuned Items

| 物品 / Item | 稀有度 / Rarity | 状态与作用 / Status and Use |
|---|---|---|
...
### 耗材、材料与资金 / Consumables, Components, and Funds
...
1. 魔法物品价格、两件免费珍稀物品与起始 **48,000 gp** 资源池是否采用本卡账本的前提。
